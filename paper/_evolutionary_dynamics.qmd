...
$\underline{p}$ to a new phenotype $\underline{p}'$. The proposed phenotype
$\underline{p}'$ is drawn from a proposal distribution $q(\underline{p}' \mid
\underline{p})$. Whether this transition occurs depends on both the relative
fitness of the new phenotype and how easily it can be reached through mutations.
Specifically, the probability of accepting a transition is given by
...
accessibility of phenotypes – even a high-fitness phenotype is unlikely to be
...
it represents the adaptive walk on the selection environment – the fitness
values we measure vary because each environment imposes its own unique fitness
landscape.
