...
shown in @fig-04, we can investigate whether the RHVAE can be used to
...
predictions to the local neighborhood of the training data---makes it difficult
to define where to trust the predictions of the model. The PCA model, on the
other hand, is not able to capture the underlying structure of the fitness
landscapes as there is a non-linear structure that cannot be captured by a
