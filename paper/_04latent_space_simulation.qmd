...
outperforms the other two models, achieving a reconstruction error that is on of
an eight-dimensional PCA model. In contrast, the 2D-RHVAE consistently
outperforms the other two models, achieving a reconstruction error that is on
par with that of a ten-dimensional PCA model. This further highlights the
ability of the RHVAE to capture the underlying nonlinear structure of the
phenotype space while maintaining high reconstruction accuracy.
...
imposed in the simulation. This suggests that, for a properly-sampled phenotypic
space, the geometric information learned by the RHVAE is able to capture the
non-uniformity of the phenotypic density as variations in the curvature of the
latent space, offering a data-driven tool to identify accessible evolutionary
