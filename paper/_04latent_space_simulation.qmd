...
As described in the Supplementary Material section H, we trained three models on the
...
truth phenotype space using Procrustes analysis (see Supplementary Material section J).
