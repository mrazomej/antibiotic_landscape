...
the HVAE, the resulting variational distribution takes the form of
@eq-hvae-variational-distribution, with the only difference that the momentum
variable is now position-dependent, i.e.,
...
\left[
    \prod_{k=1}^{K} 
    \left| \det \underline{\underline{J}}_{gk} \right|
