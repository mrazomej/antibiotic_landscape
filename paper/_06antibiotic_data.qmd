...
resistance of the evolved strains (see Supplementary Material
[@supplementalmaterial] section A for more details).
...
via Bayesian inference (see Supplementary Material [@supplementalmaterial]
section A) (D) Latent space projections using PCA, VAE, and RHVAE (first three
panels) trained on $IC_{50}$ values, with colors representing different
evolution conditions, showing improved disentanglement of lineages in nonlinear
latent spaces and superior reconstruction accuracy of RHVAE compared to other
dimensionality reduction methods. Different colors represent different lineages
evolved in different antibiotics. The rightmost panel shows the reconstruction
