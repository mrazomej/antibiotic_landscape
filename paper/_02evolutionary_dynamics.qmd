...
space remains fixed, the fitness values we measure vary because each environment
imposes its unique fitness landscape. The fitness values in all environments for
a given lineage at a given time point define one fitness profile, as the ones
depicted in @fig-01(D).
