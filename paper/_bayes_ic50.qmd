...
The experimental data used throughout this work was gently provided by the first
author of the excellent paper [@iwasawa2022]. In there, the authors evolved
*E. coli* strains on different antibiotics via an automated liquid handling
...
pronounced. experimental noise tends to be more pronounced.
