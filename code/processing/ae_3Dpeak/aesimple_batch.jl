...
encoder_activation_sc = repeat([SimpleChains.sigmoid_fast], n_hidden)
encoder_activation_flux = repeat([Flux.sigmoid_fast], n_hidden)

# Define decoder layer and activation function
decoder = repeat([n_neuron], n_hidden)
decoder_activation_sc = repeat([SimpleChains.sigmoid_fast], n_hidden)
decoder_activation_flux = repeat([Flux.sigmoid_fast], n_hidden)
