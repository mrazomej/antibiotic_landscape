...
mapslices(
    ...
    dd_latent[replicate=DD.At(1), time=1:10:end].data,
    dims=[3],
)
...
latent1_range = range(
    minimum(dd_latent[latent=DD.At(:latent1)]) - 1,
    maximum(dd_latent[latent=DD.At(:latent1)]) + 1,
    length=n_points
)
latent2_range = range(
    minimum(dd_latent[latent=DD.At(:latent2)]) - 1,
    maximum(dd_latent[latent=DD.At(:latent2)]) + 1,
    length=n_points
)
latent3_range = range(
    minimum(dd_latent[latent=DD.At(:latent3)]) - 1,
    maximum(dd_latent[latent=DD.At(:latent3)]) + 1,
    length=n_points
)
