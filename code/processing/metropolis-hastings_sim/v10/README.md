...
- 2D latent space with all sub-sampled points as centroids.
    - sub-sampling every 10th time step.
...
- number of centroids: all sub-sampled points
- centroid determination: all sub-sampled points
