...
save("$(fig_dir)/vae_loss.pdf", fig)
save("$(fig_dir)/vae_loss.png", fig)
...
save("$(fig_dir)/vae_latent_space_lineage.pdf", fig)
save("$(fig_dir)/vae_latent_space_lineage.png", fig)
...
save("$(fig_dir)/vae_latent_space_time.pdf", fig)
save("$(fig_dir)/vae_latent_space_time.png", fig)
