...
println("Defining RHVAE architectures")

# Initialize empty dictionary to save models
rhvae_dict = Dict()

# Loop through neurons
for (i, n_neuron) in enumerate(n_neurons)
    println("Neuron $i: $n_neuron")
    ...
    rhvae_dict["$(n_neuron)_model"] = rhvae
    # Add model state to dictionary
    rhvae_dict["$(n_neuron)_state"] = Flux.state(rhvae)
