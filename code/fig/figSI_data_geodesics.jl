...
## =============================================================================
# Figure SI_data_geodesics
## =============================================================================

println("Plotting FigSI_data_geodesics...")
...
for (i, p) in enumerate(pairs)
    ...
    if i == length(pairs)
        ...
        # Add colorbar
        Colorbar(gl_plots[2, 4], hm, label="√log[det(G)]")
    end
end # for p in pairs
...
# Save figure
save("$(fig_dir)/figSI_data_geodesics.png", fig)
save("$(fig_dir)/figSI_data_geodesics.pdf", fig)
