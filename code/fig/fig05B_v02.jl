...
# Save figure
save("$(fig_dir)/fig05B_v02.pdf", fig05B)

fig05B

## =============================================================================

println("Plotting Fig05B without latent trajectories...")
...
for col in 1:n_cols
    ...
    for row in 1:n_rows
        ...
        scatterlines!(
            ax,
            eachrow(data_latent)...,
            color=(color_dict[methods[row]], 0.0),
            markersize=6,
            marker=:rect,
            label="latent trajectory",
        )
        ...
        scatter!(
            ax,
            Point2f(data_latent[:, 1]),
            strokecolor=(color_dict[methods[row]], 0.0),
            color=(:white, 0.0),
            markersize=8,
            strokewidth=1.5,
            marker=:diamond,
...
# Save figure
save("$(fig_dir)/fig05B_v02_no_latent.pdf", fig05B)
